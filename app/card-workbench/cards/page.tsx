...
import stsBundle from "@/app/data/STS_CARDS_DB.json";
...
export const metadata: Metadata = {
  ...
  description:
    "Browse STS_CARDS_DB.json: edit one card’s JSON at a time, layouts for fields vs preview, export full bundle view.",
};
